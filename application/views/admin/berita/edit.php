      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          <div class="box">
            ...
            <div class="box-body">
            <?php echo form_open_multipart('admin/update_pos');?>
            <input type="hidden" name="id_berita" value="<?php echo $pos->id_berita;?>">
            <div class="col-md-8">
                    <div class="form-group">
                      <label for="exampleInputEmail1">Judul</label>
                      <input type="text" name="judul" class="form-control" value="<?php echo $pos->judul ?>" placeholder="Masukkan Judul Berita" required>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputFile">Kategori</label>
                        <input type="text" id="kategori" name="label" value="<?php echo $label ?>" class="form-control" class="tagsinput"  data-role="tagsinput" placeholder="Masukkan Kategori Berita"/>
                    </div>
            </div>
            <div align="center" class="col-md-4">
                    <div class="form-group">
                    <input type="hidden" name="t" value="<?php echo $pos->thumbnail ?>">
                      <label for="exampleInputEmail1">Gambar Fitur</label>
                                        <div class="fileupload fileupload-new g" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail gambar" style="width: 200px; height: 125px;">
                                                <img class="img-responsive" src="<?php echo base_url($pos->thumbnail) ?>" alt="" />
                                            </div>
                                            ...
                                            <div>
                                                   ...
                                                   </span><a href="#" class="btn btn-danger fileupload-exists btn-block btn-flat" data-dismiss="fileupload"><i class="fa fa-trash"></i> Hapus</a>
                                            </div>
                                        </div>
                                        </div>
                                      </div>
                    ...
                    <textarea class="textarea" name="isi" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" required><?php echo $pos->isi ?></textarea>
                    </div>
                    <div class="form-group">
